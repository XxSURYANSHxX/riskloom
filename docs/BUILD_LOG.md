...
The day-by-day engineering record of how RiskLoom was built, kept verbatim as each gate wrote it.
Nothing here has been edited or summarised in the move from `README.md`; the top-level README now
carries the judge-facing overview and the consolidated disclosures, and links here for the detail.

Read this if you want the reasoning: why a decision was made, what was measured, what was rejected
and why. Every limitation reported in these sections is also gathered in the README's
